...
#### 2. 使用技能（提速 5-10倍）
- `/zcf:git-commit-push` - Git 提交推送
- `/zcf:git-commit` - 仅提交
- `/zcf:workflow` - 结构化工作流

#### 3. 提供精确路径
- ❌ 慢："帮我找配置文件"
- ✅ 快："修改 monitor/monitor_config.py:120"
...
# 精确路径
"修改 monitor/config.py:120，添加 XXX"
...
| 操作 | 慢速方式 | 快速方式 | 提速 |
|------|---------|---------|------|
| 修改 2 个文件 | 串行 20秒 | 并行 8秒 | 2.5x |
| Git 提交 | 手动 40秒 | 技能 5秒 | 8x |
| 读取 3 个文件 | 串行 15秒 | 并行 5秒 | 3x |
